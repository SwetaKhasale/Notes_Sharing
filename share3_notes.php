 ...
 if(isset($_POST['submitted']))
{
	...
	$temp_id=mysqli_real_escape_string($con,$_POST['temp1']);
	$query="INSERT INTO user_notes(permission,shareby,shareto,user_id,note_id)VALUES('$checkbox','$shareby','$dropu',$user_id,'$temp_id')";
...
<form action="share3_notes.php" method="post">
